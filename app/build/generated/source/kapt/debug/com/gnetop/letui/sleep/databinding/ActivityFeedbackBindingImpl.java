...
public class ActivityFeedbackBindingImpl extends ActivityFeedbackBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.title_feedback, 1);
        sViewsWithIds.put(R.id.txt_feed_name, 2);
        sViewsWithIds.put(R.id.edt_feed_content, 3);
        sViewsWithIds.put(R.id.txt_feed_photo, 4);
        sViewsWithIds.put(R.id.rlv_feed_photo, 5);
        sViewsWithIds.put(R.id.txt_feed_phone, 6);
        sViewsWithIds.put(R.id.edt_feed_phone, 7);
        sViewsWithIds.put(R.id.btn_feed_upload, 8);
    }
    // views
    @NonNull
