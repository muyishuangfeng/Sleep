package com.gnetop.letui.sleep.ui.datetime;
...
public class WheelPicker<T> extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_selectedTextColor,
				getResources().getColor(R.color.colorRipple));
        mSelectedItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_selectedTextSize,
                getResources().getDimensionPixelSize(R.dimen.sp_20));
        ...
        mCurtainBorderColor = a.getColor(R.styleable.WheelPicker_wheelCurtainBorderColor,
